...
const PROJECTS = [
  {
    no: '001',
    name: <>Custom Backyard <em>Pool</em></>,
    location: 'Daphne, Alabama',
    desc: 'A backyard custom pool built for a family in Daphne. Six months from permit to first swim. Used every summer since 2022.',
    meta: 'NEW BUILD · 2022 · AL',
    placeholder: 'water',
    photo: 'images/waterscapes-photo-2.jpg',
    phLabel: 'POOL — DAPHNE RESIDENCE',
    variant: 'standard',
    slug: 'lakeside-rectangle',
  },
  {
    no: '002',
    name: <>Custom Residential <em>Pool</em></>,
    location: 'Mobile, Alabama',
    desc: 'A clean, well-built backyard pool in Midtown Mobile. Four months from permit to first swim. Used every summer since 2023.',
  ...
  },
  {
    ...
    desc: 'A backyard pool for a Spanish Fort family with four kids. Five months from permit to first swim. Used every weekend since 2023.',
    meta: 'NEW BUILD · 2023 · AL',
    placeholder: 'dusk',
    photo: 'images/waterscapes-photo-3.jpg',
  ...
  {
    no: '004',
    name: <>Custom Renovation <em>Pool</em></>,
    location: 'Mobile, Alabama',
    desc: 'A renovation of a well-built existing pool, completed in six weeks. The clients have used it every season since 2024.',
    meta: 'RENOVATION · 2024 · AL',
    placeholder: 'stone',
    photo: 'images/waterscapes-photo-4.jpg',
    phLabel: 'POOL — MOBILE RESIDENCE',
    variant: 'standard',
